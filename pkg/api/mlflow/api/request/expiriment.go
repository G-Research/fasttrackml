...
// SearchExperimentsRequest is a request object for `POST mlflow/experiments/list` or `POST mlflow/experiments/search` or `GET mlflow/experiments/search` endpoint.
