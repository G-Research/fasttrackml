...
type AimAuthTestSuite struct {
	helpers.BaseTestSuite
}

func TestAimAuthTestSuite(t *testing.T) {
	...
	testSuite := new(AimAuthTestSuite)
...
func (s *AimAuthTestSuite) Test_Ok() {
	...
	tests := []struct {
	...
	}{
		{
			...
			check: func() {
				...
				successResponse := response.GetProjectResponse{}
				s.Require().Nil(
